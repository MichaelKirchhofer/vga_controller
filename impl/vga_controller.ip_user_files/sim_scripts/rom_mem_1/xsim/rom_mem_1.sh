...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L blk_mem_gen_v8_3_2 -L unisims_ver -L unimacro_ver -L secureip --snapshot rom_mem_1 xil_defaultlib.rom_mem_1 xil_defaultlib.glbl -log elaborate.log
}
