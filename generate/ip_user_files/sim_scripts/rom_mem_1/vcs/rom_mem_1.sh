...
#
# Generated by Vivado on Tue Jan 03 16:47:06 +0100 2023
...
# executing this script. Please type 'rom_mem_1.sh -help' for more information.
#
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../rom_mem_1/rom_mem_1_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rom_mem_1 xil_defaultlib.glbl -o rom_mem_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rom_mem_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rom_mem_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc rom_mem_1_simv.daidir)
